...
public:
    ...
    QWidget *widget_2;
    QWidget *page_2;
    QTableWidget *userTbWidget;
    QLineEdit *lEditUserName;
    QLineEdit *lEditUserPasswd;
    QPushButton *btnUserAdd;
    QPushButton *btnUserDel;
    QPushButton *btnUserUp;
    QPushButton *btnUserGet;
    ...
    void setupUi(QMainWindow *StudentManagerSys)
    {
        ...
        userTbWidget = new QTableWidget(page_2);
        userTbWidget->setObjectName(QString::fromUtf8("userTbWidget"));
        userTbWidget->setGeometry(QRect(20, 90, 601, 291));
        lEditUserName = new QLineEdit(page_2);
        lEditUserName->setObjectName(QString::fromUtf8("lEditUserName"));
        lEditUserName->setGeometry(QRect(20, 10, 113, 20));
        lEditUserPasswd = new QLineEdit(page_2);
        lEditUserPasswd->setObjectName(QString::fromUtf8("lEditUserPasswd"));
        lEditUserPasswd->setGeometry(QRect(150, 10, 113, 20));
        btnUserAdd = new QPushButton(page_2);
        btnUserAdd->setObjectName(QString::fromUtf8("btnUserAdd"));
        btnUserAdd->setGeometry(QRect(210, 40, 75, 23));
        btnUserDel = new QPushButton(page_2);
        btnUserDel->setObjectName(QString::fromUtf8("btnUserDel"));
        btnUserDel->setGeometry(QRect(110, 40, 75, 23));
        btnUserUp = new QPushButton(page_2);
        btnUserUp->setObjectName(QString::fromUtf8("btnUserUp"));
        btnUserUp->setGeometry(QRect(300, 40, 75, 23));
        btnUserGet = new QPushButton(page_2);
        btnUserGet->setObjectName(QString::fromUtf8("btnUserGet"));
        btnUserGet->setGeometry(QRect(20, 40, 75, 23));
        comboBox_2 = new QComboBox(page_2);
        comboBox_2->addItem(QString());
        comboBox_2->addItem(QString());
        comboBox_2->setObjectName(QString::fromUtf8("comboBox_2"));
        comboBox_2->setGeometry(QRect(290, 10, 81, 22));
    ...
    void retranslateUi(QMainWindow *StudentManagerSys)
    {
        ...
        lEditUserName->setPlaceholderText(QCoreApplication::translate("StudentManagerSys", "\347\224\250\346\210\267\345\220\215", nullptr));
        lEditUserPasswd->setPlaceholderText(QCoreApplication::translate("StudentManagerSys", "\347\224\250\346\210\267\345\257\206\347\240\201", nullptr));
        btnUserAdd->setText(QCoreApplication::translate("StudentManagerSys", "\345\242\236\345\212\240", nullptr));
        btnUserDel->setText(QCoreApplication::translate("StudentManagerSys", "\345\210\240\351\231\244", nullptr));
        btnUserUp->setText(QCoreApplication::translate("StudentManagerSys", "\344\277\256\346\224\271", nullptr));
        btnUserGet->setText(QCoreApplication::translate("StudentManagerSys", "\346\237\245\350\257\242", nullptr));
        comboBox_2->setItemText(0, QCoreApplication::translate("StudentManagerSys", "\347\256\241\347\220\206\347\224\250\346\210\267", nullptr));
        comboBox_2->setItemText(1, QCoreApplication::translate("StudentManagerSys", "\346\231\256\351\200\232\347\224\250\346\210\267", nullptr));
